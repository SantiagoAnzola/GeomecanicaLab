...
/// </summary>
public class DefaultObserverEventHandlerModified : MonoBehaviour
{
    ...
    public InfoMaquinaController infoMaquinaController;
    ...
    void OnObserverStatusChanged(ObserverBehaviour behaviour, TargetStatus targetStatus)
    {
        ...
        if (targetStatus.Status.Equals("TRACKED"))
        {
    ...
    protected virtual void OnTrackingFound()
    {
        if (mObserverBehaviour)
        {
            var rendererComponents = VuforiaRuntimeUtilities.GetComponentsInChildrenExcluding<Renderer, DefaultObserverEventHandlerModified>(mObserverBehaviour.gameObject);
            var colliderComponents = VuforiaRuntimeUtilities.GetComponentsInChildrenExcluding<Collider, DefaultObserverEventHandlerModified>(mObserverBehaviour.gameObject);
            var canvasComponents = VuforiaRuntimeUtilities.GetComponentsInChildrenExcluding<Canvas, DefaultObserverEventHandlerModified>(mObserverBehaviour.gameObject);
            ARController aRController = FindObjectOfType<ARController>();
            aRController.OnImageTargetDetected(mObserverBehaviour);
            // Enable rendering:
